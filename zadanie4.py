...
# Funkcja do sprawdzania czy wprowadzony tekst jest liczbą całkowitą
def czy_calkowita(tekst):
    try:
        int(tekst)
        return True
    except ValueError:
...
# Sprawdzenie czy wprowadzona wartość jest liczbą całkowitą
if not czy_calkowita(liczba):
